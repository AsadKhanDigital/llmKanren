...
def gen_solutions(logic_variables, definitions, test_inputs, test_outputs, debug):
...
def gen_corpus(logic_variables, definitions, test_inputs, test_outputs, debug):
    solutions = gen_solutions(logic_variables, definitions, test_inputs, test_outputs, debug)
    ...
    if debug == "#t":
        with open("run/corpus.scm", "w") as f:
            f.write("(define exprs\n")
            f.write("  '(\n")
            f.write(solutions)
            f.write("\n))")